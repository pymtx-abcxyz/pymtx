      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-2 sm:px-6 sm:py-3">
        ...
        <div className="flex items-center gap-1 sm:gap-3">
          ...
          <button
            ref={triggerRef}
            type="button"
            className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-md text-text-primary hover:bg-surface-subtle sm:hidden"
            aria-expanded={open}
      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b border-border-subtle px-4 py-3">
            ...
            <button
              type="button"
              className="inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-md text-text-secondary hover:bg-surface-subtle hover:text-text-primary"
          ...
          <nav className="flex flex-1 flex-col gap-1 px-3 py-4" aria-label="Mobile">
            ...
            <div className="mt-6 border-t border-border-subtle px-3 pt-5">
              <p className="mb-3 text-[length:var(--text-xs)] font-semibold uppercase tracking-[0.12em] text-text-muted">
                Appearance
              </p>
              <AppearanceSettingSection compact />
            </div>
